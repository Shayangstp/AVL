...
const GetVehicleChangeReport = () => {
  ...
  const getReportVehiclesNumberIsValid = getReportVehiclesNumber.length !== 0;
  const formIsValid = groupValueIsValid && getReportVehiclesNumberIsValid;
  ...
  const validation = () => {
    ...
    if (!getReportVehiclesNumberIsValid) {
      errors.getReportVehiclesNumber = "انتخاب راننده الزامی است!";
    }
    return errors;
  };
  ...
  return (
    <div className="">
      ...
      {!getReportVehiclesNumberIsValid && (
        <p className="mt-2 font12 text-danger">
          {formErrors.getReportVehiclesNumber}
        </p>
      )}
